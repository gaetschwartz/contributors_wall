...
/// @nodoc
class _$IntHistoryTearOff {
  const _$IntHistoryTearOff();

  _IntHistory call(int current, int next) {
    return _IntHistory(
      current,
      next,
    );
...
/// @nodoc
const $IntHistory = _$IntHistoryTearOff();
...
mixin _$IntHistory {
  ...
  @JsonKey(ignore: true)
  $IntHistoryCopyWith<IntHistory> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $IntHistoryCopyWith<$Res> {
  factory $IntHistoryCopyWith(
          IntHistory value, $Res Function(IntHistory) then) =
      _$IntHistoryCopyWithImpl<$Res>;
  $Res call({int current, int next});
}

/// @nodoc
class _$IntHistoryCopyWithImpl<$Res> implements $IntHistoryCopyWith<$Res> {
  _$IntHistoryCopyWithImpl(this._value, this._then);

  final IntHistory _value;
  // ignore: unused_field
  final $Res Function(IntHistory) _then;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      next: next == freezed ? _value.next : next as int,
    ));
  }
}

/// @nodoc
abstract class _$IntHistoryCopyWith<$Res> implements $IntHistoryCopyWith<$Res> {
  factory _$IntHistoryCopyWith(
          _IntHistory value, $Res Function(_IntHistory) then) =
      __$IntHistoryCopyWithImpl<$Res>;
  @override
  $Res call({int current, int next});
}

/// @nodoc
class __$IntHistoryCopyWithImpl<$Res> extends _$IntHistoryCopyWithImpl<$Res>
    implements _$IntHistoryCopyWith<$Res> {
  __$IntHistoryCopyWithImpl(
      _IntHistory _value, $Res Function(_IntHistory) _then)
      : super(_value, (v) => _then(v as _IntHistory));

  @override
  _IntHistory get _value => super._value as _IntHistory;
  ...
  $Res call({
    ...
    return _then(_IntHistory(
      current == freezed ? _value.current : current as int,
      next == freezed ? _value.next : next as int,
    ));
  }
}

/// @nodoc
class _$_IntHistory implements _IntHistory {
  const _$_IntHistory(this.current, this.next);
  ...
  @override
  String toString() {
    return 'IntHistory(current: $current, next: $next)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _IntHistory &&
  ...
  @JsonKey(ignore: true)
  @override
  _$IntHistoryCopyWith<_IntHistory> get copyWith =>
      __$IntHistoryCopyWithImpl<_IntHistory>(this, _$identity);
}

abstract class _IntHistory implements IntHistory {
  const factory _IntHistory(int current, int next) = _$_IntHistory;
